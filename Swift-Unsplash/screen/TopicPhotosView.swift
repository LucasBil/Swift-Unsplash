...
#Preview {
    TopicPhotosView(topic: UnsplashTopic(id: "topic",slug: "slug_topic",cover_photo: UnsplashPhoto(id: "img",slug: "slug_image",user: User(name: "hop", profile_image: ProfileImage(small: "", medium: "", large: "")),urls: UnsplashPhotoUrls(raw: "raw",full: "full",regular: "regular",small: "small",thumb: "thumb")))
    )
}
